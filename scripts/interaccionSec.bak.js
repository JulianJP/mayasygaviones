...
function activadorEventosFacturar () 
{
    
    var addProducto, newPDF;
    addProducto = $("#addProducto");
    addProducto.click(agregarProducto);
    newPDF = $("#generarPDF");
    newPDF.click(generarPDF);
}

function activadorEventosCotizar () 
{
    /************************************************************************************/
    /********************       SUBOPCION COTIZAR         *******************************/
    /************************************************************************************/
    var addCotizar, newPDF_Cotizar;
        ...
        var codigoHTML= "<table border='2px'>"+
                            ...
                            "<tfoot border='0'>"+
                                "<form action='../controlador/factura.php' method='post'>"+
                                    ...
                                    "<td><button id='addProducto'>Agregar</button></td>"+
    ...
    function agregarProductoCotizado() 
    {
        $.ajax({
                ...
                success: function(data)
                {
                    ...
                    {
                        $("tbody").html("<td colspan='5' align='center' border='0'><h3>Ingrese los Productos A Cotizar</td></h3>");
                        $("#cargando").css("border","0");
                    }
                }
            });
